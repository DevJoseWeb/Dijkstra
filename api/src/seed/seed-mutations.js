export default `mutation {
    u1: CreateUser(id: "u1", name: "Herick") {
      id
      name
    }
    u2: CreateUser(id: "u2", name: "Giulia") {
      id
      name
    }
    u3: CreateUser(id: "u3", name: "Paula") {
      id
      name
    }
    u4: CreateUser(id: "u4", name: "Lourranio") {
      id
      name
    }
    u5: CreateUser(id: "u5", name: "Junior") {
      id
      name
    }
    b1: CreateBusiness(
